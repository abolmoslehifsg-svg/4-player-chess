...
function t(key){
  const fa = {
    ...
    resign: 'تسلیم', resignSeat: 'تسلیم (واگذاری به AI)', resignConfirm: 'تسلیم می‌شوی؟',
    ...
    standardDesc: 'قوانین پایه بدون ادآن', guardianDesc: 'فقط در ۲v۲ — به‌زودی',
  ...
  const en = {
    ...
    resign: 'Resign', resignSeat: 'Resign (hand to AI)', resignConfirm: 'Resign this game?',
    ...
    standardDesc: 'Base rules, no add-ons', guardianDesc: '2v2 only — coming soon',
